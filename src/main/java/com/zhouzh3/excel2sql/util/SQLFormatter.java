...
//			afterValues = true;
	...
	public static void main(String[] args) {
		String source = "create table T_ADMIN_TREE ( NODE_ID varchar(16), SUPER_ID varchar(16), NODE_NAME varchar(32), NODE_CODE varchar(128) );";
		String sql = new SQLFormatter().format(source);
